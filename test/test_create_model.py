...
def test(input_directory):
    ...
    create_model(absolute_path, height=1.4, weight=40, create_muscles=True, testing=False, scale_factor=1000)


if __name__ == "__main__":
    # TODO: Move test data into test directory.
    test("..\\..\\src\\opensim_model_creator\\Participants\\Jinella 01 Fibula")
