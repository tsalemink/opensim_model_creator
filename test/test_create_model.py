...
def test(input_directory, subject_info):
    ...
    create_model(static_trc, dynamic_trc, output_directory, static_marker_data, subject_info, 9, left_foot_flat=True, right_foot_flat=True, optimise_knee_axis = False)
